  ...
  return (
    <div className="min-h-screen bg-white dark:bg-neutral-950">
      ...
      <div className="relative">
        ...
        <div className="bg-gradient-to-r from-orange-500 via-red-500 to-pink-500 h-40 w-full"></div>
        
        {/* Profile content overlay */}
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center text-white">
            <div className="w-32 h-32 rounded-full flex items-center justify-center text-4xl font-bold text-white bg-white/20 backdrop-blur-sm border-4 border-white/30 shadow-2xl mb-4">
      ...
      <div className="max-w-4xl mx-auto px-4 -mt-20 pb-8">
        ...
        <div className={`rounded-2xl p-8 mb-8 border ${
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className={`rounded-xl p-6 border transition-all duration-200 hover:scale-105 ${
              dark 
              ...
              <div className="flex items-center gap-3 mb-3">
                <div className="w-12 h-12 rounded-full bg-slate-100 dark:bg-slate-700 flex items-center justify-center shadow-inner">
              ...
              <div className={`text-2xl font-bold ${dark ? "text-slate-100" : "text-slate-800"}`}>
            ...
            <div className={`rounded-xl p-6 border transition-all duration-200 hover:scale-105 ${
              ...
              <div className="flex items-center gap-3 mb-3">
                <div className="w-12 h-12 rounded-full bg-emerald-100 dark:bg-emerald-700 flex items-center justify-center shadow-inner">
              ...
              <div className={`text-2xl font-bold ${dark ? "text-emerald-100" : "text-emerald-800"}`}>
            ...
            <div className={`rounded-xl p-6 border transition-all duration-200 hover:scale-105 ${
              ...
              <div className="flex items-center gap-3 mb-3">
                <div className="w-12 h-12 rounded-full bg-amber-100 dark:bg-amber-700 flex items-center justify-center shadow-inner">
              ...
              <div className={`text-2xl font-bold ${dark ? "text-amber-100" : "text-amber-800"}`}>
                +{profileData.score}
              </div>
            </div>
          </div>
