          ...
          <div className="p-4 border-b border-neutral-200 dark:border-neutral-700 bg-gradient-to-r from-orange-500 to-orange-600 flex-shrink-0">
            <div className="flex items-center justify-between mb-3">
              ...
              <button
                onClick={loadChats}
                disabled={isLoading}
                className="p-2 bg-white/20 text-white rounded-lg hover:bg-white/30 disabled:opacity-50 transition-colors"
              >
                {isLoading ? (
            ...
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="px-2 py-1 rounded text-xs font-medium text-orange-100 hover:bg-white/20 transition-colors"
              >
                Mark all read
              </button>
            </div>
          ...
          <div className="flex-1 overflow-y-auto">
            {isLoading ? (
              ...
              <div className="p-4 text-center">
                ...
                <h3 className="font-medium text-neutral-900 dark:text-white mb-1 text-sm">No messages or notifications</h3>
        ...
        <div className="flex-1 bg-white dark:bg-neutral-900 flex flex-col">
          {!selectedChat && !selectedNotification ? (
            ...
            <div className="flex-1 flex flex-col">
              <div className="p-4 border-b border-neutral-200 dark:border-neutral-700 bg-gradient-to-r from-purple-500 to-purple-600 flex-shrink-0">
                <div className="flex items-center justify-between">
              ...
              <div className="flex-1 overflow-y-auto p-4">
                {messages.length === 0 ? (
                  <div className="text-center py-8">
                    <div className="w-12 h-12 bg-neutral-100 dark:bg-neutral-800 rounded-2xl flex items-center justify-center mx-auto mb-3">
                      <svg className="w-6 h-6 text-neutral-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 12h.01M12h.01M16h.01M21 12c0 4.418-4.03 8-9 8a9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                      </svg>
                    </div>
                    <h3 className="font-medium text-neutral-900 dark:text-white mb-1">No messages yet</h3>
