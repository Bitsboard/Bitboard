        ...
        {showArrows && validImages.length > 1 && (
          <>
            <button
              ...
              className={cn(
                "absolute left-2 top-1/2 -translate-y-1/2 rounded-full p-2 backdrop-blur-sm transition",
            ...
            <button
              ...
              className={cn(
                "absolute right-2 top-1/2 -translate-y-1/2 rounded-full p-2 backdrop-blur-sm transition",
                dark ? "bg-neutral-900/60 text-neutral-200 hover:bg-neutral-900/80" : "bg-white/70 text-neutral-800 hover:bg-white"
              )}
            ...
            {validImages.map((_, i) => (
              <div
                ...
                className={cn(
                  ...
                  i === index ? (dark ? "bg-white" : "bg-neutral-900") : (dark ? "bg-white/40" : "bg-neutral-900/30")
                )}
              />)
            )}
          </div>
