                ...
                {showArrows && validImages.length > 1 && (
                    <>
                        <button
                            ...
                            className={cn(
                                "absolute left-2 top-1/2 -translate-y-1/2 rounded-xl p-3 transition bg-gradient-to-r from-orange-500 to-red-500 text-white shadow-xl hover:from-orange-400 hover:to-red-400",
                        ...
                        <button
                            ...
                            className={cn(
                                "absolute right-2 top-1/2 -translate-y-1/2 rounded-xl p-3 transition bg-gradient-to-r from-orange-500 to-red-500 text-white shadow-xl hover:from-orange-400 hover:to-red-400",
