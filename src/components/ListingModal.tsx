      ...
      <div className="relative">
        ...
        <div className={cn("md:col-span-2 border-l flex flex-col", dark ? "border-neutral-900" : "border-neutral-200")} style={{ maxHeight: "calc(90vh - 64px)" }}> 
          <div className="p-4 pr-6 shrink-0">
            ...
            {/* Two-column row: left (warning + report), right (seller + button + report) */}
            <div className="mb-2 grid grid-cols-2 gap-4">
              ...
              <div className="flex flex-col items-end gap-2">
                ...
                <button onClick={onChat} className="min-w-[240px] rounded-xl bg-gradient-to-r from-orange-500 to-red-500 px-6 py-2 text-sm font-semibold text-white shadow">Send a Message</button>
                <span className={cn("text-sm font-bold cursor-pointer", dark ? "text-red-400" : "text-red-600")}>{t('report_listing', lang)}</span>
              </div>
            </div>
            <div className={cn("my-3 h-px", dark ? "bg-neutral-900" : "bg-neutral-200")} />
