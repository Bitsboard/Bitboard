            ...
            <div className="flex items-center gap-2">
              ...
              {user.handle ? (
                <a 
                  ...
                  className="inline-flex items-center gap-3 px-4 h-10 rounded-2xl bg-neutral-100/80 dark:bg-neutral-800/50 hover:bg-neutral-200/80 dark:hover:bg-neutral-700/50 transition-all duration-200 group border border-neutral-300/50 dark:border-neutral-700/50"
                >
                  {avatarUrl ? (
