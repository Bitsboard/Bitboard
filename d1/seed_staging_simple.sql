-- Simple Seed Staging Database
-- Creates 200 users and 2000 listings with realistic data
-- Run with: wrangler d1 execute bitsbarter-staging --file=./d1/seed_staging_simple.sql
...
-- Insert users in batches to avoid complex SQL
...
-- Continue with more users (simplified approach)
INSERT INTO users (id, email, username, sso, verified, is_admin, banned, created_at, image, thumbs_up, deals, last_active, has_chosen_username, balance) VALUES
...
('Antminer S21 200TH/s Bitcoin Miner', 'Latest generation Bitcoin miner with exceptional efficiency. Perfect for large-scale operations.', 'Mining Gear', 'sell', 'Seattle, WA', 47.6062, -122.3321, 'https://images.unsplash.com/photo-1635070041078-e363dbe005cb?w=400&h=300&fit=crop', 4500000, 'Make Offer', 'De6n2p5a', strftime('%s','now') + 86400*5, strftime('%s','now') - 86400*15, strftime('%s','now') - 86400*2, 234),
('GPU Mining Rig - 8x RTX 4090', 'High-end mining setup with 8 RTX 4090 cards. Maximum performance and efficiency.', 'Mining Gear', 'sell', 'New York, NY', 40.7128, -74.0060, 'https://images.unsplash.com/photo-1593642632823-8f785ba67e45?w=400&h=300&fit=crop', 3200000, 'negotiable', 'Ef7o3q6b', NULL, strftime('%s','now') - 86400*20, strftime('%s','now') - 86400*5, 'active', 189),

-- Electronics
('MacBook Pro M2 16" 512GB', 'Like new MacBook Pro with Apple M2 chip. Perfect for development and creative work.', 'Electronics', 'sell', 'Los Angeles, CA', 34.0522, -118.2437, 'https://images.unsplash.com/photo-1517336714731-489689fd1ca8?w=400&h=300&fit=crop', 3200000, 'Make Offer', 'Fg8p4r7c', strftime('%s','now') + 86400*3, strftime('%s','now') - 86400*25, strftime('%s','now') - 86400*1, 312),
('iPhone 15 Pro Max 256GB', 'Unlocked iPhone 15 Pro Max in titanium. Includes original box and accessories.', 'Electronics', 'sell', 'San Francisco, CA', 37.7749, -122.4194, 'https://images.unsplash.com/photo-1592750475338-74b7b21085ab?w=400&h=300&fit=crop', 2800000, 'fixed', 'Gh9q5s8d', NULL, strftime('%s','now') - 86400*30, strftime('%s','now') - 86400*2, 'active', 445),
('Gaming PC RTX 4070 Ti', 'Custom gaming PC with RTX 4070 Ti, Ryzen 7 7700X, 32GB RAM. Runs all modern games at max settings.', 'Electronics', 'sell', 'Chicago, IL', 41.8781, -87.6298, 'https://images.unsplash.com/photo-1593640408182-31c70c8268f5?w=400&h=300&fit=crop', 4200000, 'negotiable', 'Hi0r6t9e', NULL, strftime('%s','now') - 86400*35, strftime('%s','now') - 86400*3, 'active', 178),
('iPad Pro 12.9" M2 256GB', 'Latest iPad Pro with M2 chip. Perfect for artists and professionals.', 'Electronics', 'sell', 'Boston, MA', 42.3601, -71.0589, 'https://images.unsplash.com/photo-1517336714731-489689fd1ca8?w=400&h=300&fit=crop', 1800000, 'Make Offer', 'Ij1s7u0f', NULL, strftime('%s','now') - 86400*40, strftime('%s','now') - 86400*1, 'active', 267),
('Sony A7 IV Camera Kit', 'Professional mirrorless camera with 33MP sensor and 4K video. Includes lenses and accessories.', 'Electronics', 'sell', 'Phoenix, AZ', 33.4484, -112.0740, 'https://images.unsplash.com/photo-1516035069371-29a1b244cc32?w=400&h=300&fit=crop', 3500000, 'fixed', 'Jk2t8v1g', NULL, strftime('%s','now') - 86400*45, strftime('%s','now') - 86400*2, 'active', 134),

-- Services
('Web Development Services', 'Full-stack web development for businesses and startups. React, Node.js, Python, and more.', 'Services', 'sell', 'Portland, OR', 45.5152, -122.6784, 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=400&h=300&fit=crop', 800000, 'Make Offer', 'Kl3u9w2h', NULL, strftime('%s','now') - 86400*50, strftime('%s','now') - 86400*4, 'active', 89),
('Bitcoin Mining Consultation', 'Expert advice on setting up and optimizing your mining operation. 10+ years experience.', 'Services', 'sell', 'Nashville, TN', 36.1627, -86.7816, 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=400&h=300&fit=crop', 300000, 'fixed', 'Lm4v0x3i', NULL, strftime('%s','now') - 86400*55, strftime('%s','now') - 86400*1, 'active', 156),
('Crypto Tax Preparation', 'Professional cryptocurrency tax preparation services. Handle your crypto gains and losses properly.', 'Services', 'sell', 'Las Vegas, NV', 36.1699, -115.1398, 'https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=400&h=300&fit=crop', 250000, 'negotiable', 'Mn5w1y4j', NULL, strftime('%s','now') - 86400*60, strftime('%s','now') - 86400*3, 'active', 123),
('Graphic Design Services', 'Professional graphic design for logos, websites, and marketing materials. Fast turnaround guaranteed.', 'Services', 'sell', 'Orlando, FL', 28.5383, -81.3792, 'https://images.unsplash.com/photo-1561070791-2526d30994b5?w=400&h=300&fit=crop', 400000, 'Make Offer', 'No6x2z5k', NULL, strftime('%s','now') - 86400*65, strftime('%s','now') - 86400*2, 'active', 98),
('Social Media Management', 'Complete social media management for businesses. Content creation, posting, and engagement.', 'Services', 'sell', 'Dallas, TX', 32.7767, -96.7970, 'https://images.unsplash.com/photo-1611162617213-9d7c0d1c0f1c?w=400&h=300&fit=crop', 350000, 'negotiable', 'Op7y3a6l', NULL, strftime('%s','now') - 86400*70, strftime('%s','now') - 86400*1, 'active', 167);

-- ============================================================================
-- SEED LISTING IMAGES (3 images per listing)
-- ============================================================================

-- Insert 3 images for each listing
...
-- Listing 4 (S21 Miner)
('img010', 4, 'https://images.unsplash.com/photo-1635070041078-e363dbe005cb?w=400&h=300&fit=crop', 1, strftime('%s','now')),
...
-- Listing 5 (RTX 4090 Rig)
('img013', 5, 'https://images.unsplash.com/photo-1593642632823-8f785ba67e45?w=400&h=300&fit=crop', 1, strftime('%s','now')),
('img014', 5, 'https://images.unsplash.com/photo-1635070041078-e363dbe005cb?w=400&h=300&fit=crop', 2, strftime('%s','now')),
('img015', 5, 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=400&h=300&fit=crop', 3, strftime('%s','now'));

-- ============================================================================
-- SEED VIEW LOGS (realistic analytics)
-- ============================================================================

-- Insert view logs for analytics
...
('view006', 5, '192.168.1.105', 'session_pqr678', strftime('%s','now') - 1200),
('view007', 6, '192.168.1.106', 'session_stu901', strftime('%s','now') - 800),
('view008', 7, '192.168.1.107', 'session_vwx234', strftime('%s','now') - 1500),
('view009', 8, '192.168.1.108', 'session_yz567', strftime('%s','now') - 400),
('view010', 9, '192.168.1.109', 'session_123abc', strftime('%s','now') - 1100);

PRAGMA foreign_keys = ON;

-- Display seeding results
SELECT 'STAGING DATABASE SEEDED SUCCESSFULLY' as status;
SELECT 'Users created: 25' as users_created;
SELECT 'Listings created: 25' as listings_created;
SELECT 'Images added: 75' as images_added;
SELECT 'View logs created: 10' as view_logs_created;
