-- Bulk Seed Staging Database
-- Creates 200 users and 2000 listings with realistic data
-- Run with: wrangler d1 execute bitsbarter-staging --file=./d1/seed_staging_bulk.sql
...
-- Insert 200 users with realistic data
...
SELECT 
    ...
    'user' || (rowid + 1) || '@example.com' as email,
    'User' || (rowid + 1) as username,
    CASE (rowid % 3) WHEN 0 THEN 'google' WHEN 1 THEN 'apple' ELSE 'facebook' END as sso,
    CASE WHEN rowid < 180 THEN 1 ELSE 0 END as verified,
    CASE WHEN rowid = 0 THEN 1 ELSE 0 END as is_admin,
    0 as banned,
...
-- Insert 2000 listings with realistic data
...
SELECT 
    CASE (rowid % 7)
        ...
        WHEN 1 THEN 'GPU Mining Rig - ' || (6 + random() % 4) || 'x RTX ' || (3060 + random() % 5 * 10)
        ...
        WHEN 4 THEN 'Web Development Services - ' || CASE (random() % 3) WHEN 0 THEN 'React' WHEN 1 THEN 'Node.js' ELSE 'Python' END
        WHEN 5 THEN 'Smart Home Security System - ' || CASE (random() % 3) WHEN 0 THEN '4K Cameras' WHEN 1 THEN 'Motion Sensors' ELSE 'Mobile App' END
    ...
    CASE (rowid % 20)
        ...
        WHEN 1 THEN 'Miami, FL'
        WHEN 2 THEN 'Denver, CO'
        WHEN 3 THEN 'Seattle, WA'
        WHEN 4 THEN 'New York, NY'
        WHEN 5 THEN 'Los Angeles, CA'
        WHEN 6 THEN 'San Francisco, CA'
        WHEN 7 THEN 'Chicago, IL'
        WHEN 8 THEN 'Boston, MA'
        WHEN 9 THEN 'Phoenix, AZ'
        WHEN 10 THEN 'Portland, OR'
        WHEN 11 THEN 'Nashville, TN'
        WHEN 12 THEN 'Las Vegas, NV'
        WHEN 13 THEN 'Orlando, FL'
        WHEN 14 THEN 'Dallas, TX'
        WHEN 15 THEN 'Houston, TX'
        WHEN 16 THEN 'Atlanta, GA'
        WHEN 17 THEN 'Philadelphia, PA'
        WHEN 18 THEN 'Detroit, MI'
        ELSE 'Minneapolis, MN'
    END as location,
    CASE (rowid % 20)
    ...
    CASE (rowid % 3) WHEN 0 THEN 'fixed' WHEN 1 THEN 'negotiable' ELSE 'Make Offer' END as pricing_type,
...
SELECT 
    'img' || printf('%06d', rowid + 1) as id,
    (rowid / 3) + 1 as listing_id,
    'https://images.unsplash.com/photo-' || (1500000000 + random() % 100000000) || '?w=400&h=300&fit=crop' as image_url,
