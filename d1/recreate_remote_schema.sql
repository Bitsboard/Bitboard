-- Recreate Remote Staging Database Schema
-- This script recreates the correct schema on the remote staging database
-- Run with: wrangler d1 execute bitsbarter-staging --remote --file=./d1/recreate_remote_schema.sql
