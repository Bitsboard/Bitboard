var p={},F=($,y,A)=>(p.__chunk_855=()=>{},p.__chunk_3808=(j,D,O)=>{"use strict";let i,a,s,w,d;var q=Object.create,c=Object.defineProperty,E=Object.getOwnPropertyDescriptor,f=Object.getOwnPropertyNames,P=Object.getPrototypeOf,C=Object.prototype.hasOwnProperty,g=(e,t,o,n)=>{if(t&&typeof t=="object"||typeof t=="function")for(let r of f(t))C.call(e,r)||r===o||c(e,r,{get:()=>t[r],enumerable:!(n=E(t,r))||n.enumerable});return e},R=(i={"../../node_modules/dedent-tabs/dist/dedent-tabs.js"(e){Object.defineProperty(e,"__esModule",{value:!0}),e.default=function(t){for(var o=typeof t=="string"?[t]:t.raw,n="",r=0;r<o.length;r++)if(n+=o[r].replace(/\\\n[ \t]*/g,"").replace(/\\`/g,"`").replace(/\\\$/g,"$").replace(/\\\{/g,"{"),r<(1>=arguments.length?0:arguments.length-1)){var S=n.substring(n.lastIndexOf(`
...
`)}}},function(){return a||(0,i[f(i)[0]])((a={exports:{}}).exports,a),a.exports}),h={};((e,t)=>{for(var o in t)c(e,o,{get:t[o],enumerable:!0})})(h,{getOptionalRequestContext:()=>b,getRequestContext:()=>M}),j.exports=g(c({},"__esModule",{value:!0}),h),O(855);var m=(d=(s=R())!=null?q(P(s)):{},g(!w&&s&&s.__esModule?d:c(d,"default",{value:s,enumerable:!0}),s)),k=Symbol.for("__cloudflare-request-context__");function b(){let e=y[k];if((process?.release?.name==="node"?"nodejs":"edge")=="nodejs")throw Error(m.default`
