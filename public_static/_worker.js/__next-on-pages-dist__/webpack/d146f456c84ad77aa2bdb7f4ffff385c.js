...
`)}}},function(){return a||(0,c[f(c)[0]])((a={exports:{}}).exports,a),a.exports}),h={};((e,t)=>{for(var o in t)i(e,o,{get:t[o],enumerable:!0})})(h,{getOptionalRequestContext:()=>b,getRequestContext:()=>M}),O.exports=g(i({},"__esModule",{value:!0}),h),j(855);var m=(d=(s=R())!=null?q(P(s)):{},g(!w&&s&&s.__esModule?d:i(d,"default",{value:s,enumerable:!0}),s)),k=Symbol.for("__cloudflare-request-context__");function b(){let e=y[k];if((process?.release?.name==="node"?"nodejs":"edge")=="nodejs")throw Error(m.default`
